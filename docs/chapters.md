...
- Digital readout: event-based vs frame-based (vs trigger based)
- Integration: pixel parallel vs column parallel, monolithic vs hybrid (bump / bonding) = 5 different options

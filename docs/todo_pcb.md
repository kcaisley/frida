...
- [x] THS4541 amplifier footprint and 3D model added to local library
...
| - | Molex Mini-Fit Jr 2x02 (469990014) | `frida:Molex_MiniFitJr_469990014` | `frida:Molex_MiniFitJr_469990014` | `Molex_MiniFitJr_469990014.stp` |
...
| - | TXV0106-Q1 level shifter | `frida:TI_LevelShifter_TXV0106Q1` | `Package_DFN_QFN:WQFN-16-1EP_4x4mm_P0.5mm_EP2.6x2.6mm` | `TI_LevelShifter_TXV0106Q1.stp` |

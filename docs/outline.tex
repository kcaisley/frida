...
% The Uni Bonn thesis package is provided by libs/ubonn-thesis. The docs
% Makefile adds that submodule to TEXINPUTS so the package can be loaded by
% name, just as in the upstream thesis skeleton.
\usepackage[
  twoside=false,
  biblatex=false,
  newtx=false,
...
\chapter[Implementation of a 65 nm prototype]{Implementation of a 65\,nm prototype}

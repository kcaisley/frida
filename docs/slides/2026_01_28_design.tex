...
\begin{frame}
  ...
  \begin{center}
    \begin{tabular}{p{2.2cm}|p{4.2cm}|p{4.8cm}}
      ...
      \hline
      1) Calibration & % chktex 10 (numbered strategy label)
      ...
      \hline
      2) Redundancy (sub-radix, M:N expansion) & % chktex 10 (numbered strategy label)
      ...
      \hline
      3) Coarse-fine CDAC partition & % chktex 10 (numbered strategy label)
      ...
      \hline
      4) Switching scheme choice & % chktex 10 (numbered strategy label)
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \begin{column}{0.65\textwidth}
      ...
      \]
      Only 7\% mismatch penalty --- early stages have $C_\mathrm{diff} \ll C_\mathrm{main}$
      \end{center}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}
  ...
  \begin{center}
    \begin{tabular}{l|c|c}
      \hline
      \textbf{Stages} & \textbf{Output W (NMOS)} & \textbf{Output W (PMOS)} \\
      \hline
      C0--C1 & 3.12 $\mu$m & 4.16 $\mu$m \\
      C2--C3 & 1.56 $\mu$m & 2.08 $\mu$m \\
      C4--C15 & 0.78 $\mu$m & 1.04 $\mu$m \\
      \hline
    \end{tabular}
  \end{center}
\end{frame}
  ...
  \begin{columns}
    \begin{column}{0.5\textwidth}
      ...
      \begin{tabular}{l|l|c}
        ...
        \texttt{subrdx2rdst} & Largest-stage redistribution & $\sim$2.0 \\

...
\makecell[tl]{PETRA III\\(DESY)}
  ...
  & {\sim}\,10^{12}\text{--}10^{13}
  & \makecell[tl]{62.5\,\text{MHz}\;(16\,\text{ns})\\\text{or }5.2\,\text{MHz}\;(192\,\text{ns})}
  & {\sim}\,100\,\text{ps}
  & {\sim}\,10^{4}\text{--}10^{5}
...
\makecell[tl]{ESRF-EBS\\(Grenoble)}
  ...
  & {\sim}\,10^{13}
  & \makecell[tl]{352\,\text{MHz}\;(2.8\,\text{ns})\\\text{or }5.7\,\text{MHz}\;(176\,\text{ns})}
...
\makecell[tl]{EuXFEL\\SP mode\\(DESY)}
  ...
  & \makecell[tl]{4.5\,\text{MHz}\;(222\,\text{ns})\\\text{intra-train;}\\10\,\text{Hz trains}\\\text{(up to 2700/train)}}
...
\makecell[tl]{Talos F200X\\(Thermo Fisher)}
  & S/TEM
  & e^{-},\; 200\,\text{keV}
  & \makecell[tl]{9.4 \times 10^{9}\\(1.5\,\text{nA})}
  & \text{DC (continuous)}
  & \text{DC}
  & \text{N/A (DC beam)}
...
\makecell[tl]{Talos F200\\(Thermo Fisher)}
  & S/TEM
  & e^{-},\; 200\,\text{keV}
  & \makecell[tl]{1.4 \times 10^{9}\\(220\,\text{pA})}
  & \text{DC (continuous)}
  & \text{DC}
  & \text{N/A (DC beam)}
...
\makecell[tl]{Spectra 200/300\\(Thermo Fisher)}
  ...
  & \makecell[tl]{6.2 \times 10^{9}\\({>}1\,\text{nA})}
  & \text{DC (continuous)}
  & \text{DC}
  & \text{N/A (DC beam)}
...
\makecell[tl]{Titan Themis\\(Thermo Fisher)}
  & S/TEM
  & e^{-},\; 300\,\text{keV}
  & \makecell[tl]{1.2 \times 10^{10}\\(2\,\text{nA})}
  & \text{DC (continuous)}
  & \text{DC}
  & \text{N/A (DC beam)}
...
\makecell[tl]{JEM-ARM300F2\\(JEOL)}
  & S/TEM
  & e^{-},\; 300\,\text{keV}
  & \makecell[tl]{3.1 \times 10^{6}\\(0.5\,\text{pA})}
  & \text{DC (continuous)}
  & \text{DC}
  & \text{N/A (DC beam)}
...
\makecell[tl]{ELSA X3ED\\(Uni Bonn)}
  ...
  & \makecell[tl]{300\,\text{Hz}\text{--}4\times10^{8}\\(\text{aA--}100\,\text{pA})}
  & \text{DC (continuous)}
  & \text{DC}
  & \text{N/A (DC beam)}

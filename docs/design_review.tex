...
%% ============================================================
\begin{frame}[fragile]
  \frametitle{ADC Floorplan Overview}
  \begin{center}
  \begin{lstlisting}[basicstyle=\ttfamily\fontsize{5}{6}\selectfont,frame=none,backgroundcolor=\color{white}]
...
%% ============================================================
\begin{frame}
  \frametitle{ADC Top-Level Netlist}
  \begin{center}
    \includegraphics[width=\linewidth,height=0.85\textheight,keepaspectratio]{images/adc_top_netlistsvg.pdf}
  \end{center}
\end{frame}
  ...
  \begin{columns}
    ...
    \begin{column}{0.55\textwidth}
      \begin{itemize}
        ...
        \item DAC pins on left/right edges (M3)
...
\begin{frame}
  ...
  \begin{columns}
    \begin{column}{0.5\textwidth}
      \begin{center}
        \includegraphics[width=0.9\linewidth,height=0.7\textheight,keepaspectratio]{images/4_1_cts_alt.png}
      \end{center}
    \end{column}
    \begin{column}{0.5\textwidth}
      \begin{center}
        \includegraphics[width=0.9\linewidth,height=0.7\textheight,keepaspectratio]{images/4_1_treeview.png}
      \end{center}
    \end{column}
  \end{columns}
\end{frame}
...
%% ============================================================
%% OpenROAD Step 6.1 IR Drop Analysis
%% ============================================================
\begin{frame}[fragile]
  \frametitle{OpenROAD Step 6.1: IR Drop / Thermal Analysis}
  \begin{columns}
    \begin{column}{0.45\textwidth}
      \begin{center}
    ...
    \begin{column}{0.55\textwidth}
      \begin{itemize}
        \item IR drop analysis across power grid
        \item Validates PDN adequacy
        \item Identifies potential hot spots
      \end{itemize}
      \vspace{1em}
      \textbf{pdn.tcl}
      \begin{lstlisting}[language=tcl]
...
# Vertical M4 stripes at edges
# Horizontal M1 following std cells
# M1-M4 via connections
      \end{lstlisting}
    \end{column}
  \end{columns}
\end{frame}

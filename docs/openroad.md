...
>>> read_verilog results/tsmc65/frida_adc/base/1_2_yosys.v write_cdl -masters
>>> "platforms/tsmc65/spice/tcbn65lplvt_200a.spi ~/frida/etc/sampswitch.cdl ~/frida/etc/comp.cdl
>>> ~/frida/etc/caparray.cdl" results/tsmc65/frida_adc/base/output.cdl

...
params["CDAC"]["individual_weights"] = [768, 512, 320, 192, 96, 64, 32, 24, 12, 10, 5, 4, 4, 2, 1, 1]  # Binary recombination weights from caparray
...
params["CDAC"]["settling_time"] = 0.5e-9  # TBD: individual settling errors per capacitor?

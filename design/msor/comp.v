...
module Comp (
    ...
    sg13_lv_nmos mdiff_p1 (
        .d(outn_int),
        .g(inp),
        .s(tail),
        .b(vss)
    );
    sg13_lv_nmos mdiff_p2 (
        .d(outn_int),
        .g(inp),
        .s(tail),
        .b(vss)
    );
    sg13_lv_nmos mdiff_p3 (
        .d(outn_int),
        .g(inp),
        .s(tail),
        .b(vss)
    );
    sg13_lv_nmos mdiff_p4 (
        .d(outn_int),
        .g(inp),
        .s(tail),
        .b(vss)
    ...
    sg13_lv_nmos mdiff_n1 (
        .d(outp_int),
        .g(inn),
        .s(tail),
        .b(vss)
    );
    sg13_lv_nmos mdiff_n2 (
        .d(outp_int),
        .g(inn),
        .s(tail),
        .b(vss)
    );
    sg13_lv_nmos mdiff_n3 (
        .d(outp_int),
        .g(inn),
        .s(tail),
        .b(vss)
    );
    sg13_lv_nmos mdiff_n4 (
        .d(outp_int),
        .g(inn),
        .s(tail),
        .b(vss)
    ...
    sg13_lv_pmos mrst_p1 (
        .d(outn_int),
        .g(clk),
        .s(vdd),
        .b(vdd)
    );
    sg13_lv_pmos mrst_p2 (
        .d(outn_int),
        .g(clk),
        .s(vdd),
        .b(vdd)
    ...
    sg13_lv_pmos mrst_n1 (
        .d(outp_int),
        .g(clk),
        .s(vdd),
        .b(vdd)
    );
    sg13_lv_pmos mrst_n2 (
        .d(outp_int),
        .g(clk),
        .s(vdd),
        .b(vdd)
    ...
    sg13_lv_pmos mlatch_rst_p1 (
        .d(outn_int),
        .g(clk),
        .s(vdd),
        .b(vdd)
    );
    sg13_lv_pmos mlatch_rst_p2 (
        .d(outn_int),
        .g(clk),
        .s(vdd),
        .b(vdd)
    ...
    sg13_lv_pmos mlatch_rst_n1 (
        .d(outp_int),
        .g(clk),
        .s(vdd),
        .b(vdd)
    );
    sg13_lv_pmos mlatch_rst_n2 (
        .d(outp_int),
        .g(clk),
        .s(vdd),
        .b(vdd)

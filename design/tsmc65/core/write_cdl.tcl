...
write_cdl -masters "/home/kcaisley/OpenROAD-flow-scripts/flow/platforms/tsmc65/spice/tcbn65lplvt_200a.spi /home/kcaisley/frida/spice/adc.cdl /home/kcaisley/OpenROAD-flow-scripts/flow/platforms/tsmc65/spice/fillers.cdl" \
...
set include_header "* CDL Netlist generated by OpenROAD\n*\n* Include files for hierarchy\n.INCLUDE \"/home/kcaisley/frida/spice/adc.cdl\"\n\n"
set fd [open $::env(RESULTS_DIR)/6_final.cdl w]
puts -nonewline $fd $include_header
puts -nonewline $fd $cdl_content
close $fd

# Add analog pins (vin_p vin_n vdd_a vss_a vdd_d vss_d vdd_dac vss_dac) to the .SUBCKT core port list
# Find the last line of the .SUBCKT core definition (line starting with +) and append the analog pins
exec sed -i {/^\.SUBCKT core/,/^[^+]/{s/^\(+.*[^ ]\)$/\1 vin_p vin_n vdd_a vss_a vdd_d vss_d vdd_dac vss_dac/; t; b}} $::env(RESULTS_DIR)/6_final.cdl

# Copy CDL to frida/spice directory
exec cp $::env(RESULTS_DIR)/6_final.cdl /home/kcaisley/frida/spice/core.cdl
puts "Copied CDL to /home/kcaisley/frida/spice/core.cdl (filler and decap instances removed, analog pins added)"

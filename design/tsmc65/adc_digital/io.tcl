...
set_io_pin_constraint -pin_names {dac_diffcaps dac_mode comp_out seq_init seq_samp seq_comp seq_update en_init en_samp_p en_samp_n en_comp en_update} -region bottom:21-39 -group -order

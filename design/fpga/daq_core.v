...
module daq_core #(
    ...
    wire [7:0] gpio; // gpio[7:4] are unused
    ...
    // 6. LEDs: Blinking pattern for all 8 LEDs with adjusted frequency
    reg [7:0] blink_pattern = 8'b10101010;
    reg [23:0] blink_counter = 0;
    localparam BLINK_INTERVAL = 24_000_000; // Adjust this value to change blinking frequency

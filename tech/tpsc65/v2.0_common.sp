...
* MISSING VALUE (or obsolete param).param log_WLantennadiode = 
*DFF_POZ diode
.param std_LPOZdiode = 2.35u
.param std_WPOZdiode = 0.5u
* MISSING VALUE (or obsolete param).param log_LPOZdiode = 
* MISSING VALUE (or obsolete param).param log_WPOZdiode = 
...
*model name (experimental)
* .param CPOD_model = 
.param CPOD_1pF_W = 73u
.param CPOD_1pF_L = 3.8u
.param CPOD_ffperum2 = 3.6
*std accumulation capacitor
.param CACC = 2
.param CACC_1pF_W = 36u
.param CACC_1pF_L = 6u
.param CACC_ffperum2 = 4.62
*high density MIMH
* .param CMIMH = 
*model name
* .param CMIMH_model = 
...
.param IO_ESD_Rsheet = 195
.param IO_ESD50_L = 5.1u
.param IO_ESD50_W = 20u
.param IO_ESD20_L = 4.10u
*should evolve to W<=40u
.param IO_ESD20_W = 40u

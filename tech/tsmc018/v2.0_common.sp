...
.param std_nmos_lowVth_Lmin = 0.5u
.param std_pmos_lowVth_Lmin = 0.5u
...
.param std_Crhgs = 0.9f
.param std_Crhgd = 0.9f
...
.param std_Lrpoly10 = 2.5u
.param std_Wrpoly10 = 30u
.param std_Lrpoly100 = 2.5u
*values optimized by simulation  for xs tt +25deg
.param std_Wrpoly100 = 3u
.param std_Lrpoly1k = 16.55u
.param std_Wrpoly1k = 2u
.param std_Lrpoly10k = 35.3u
.param std_Wrpoly10k = 0.5u
.param std_Lrpoly100k = 179.4u
.param std_Wrpoly100k = 0.3u
.param std_Lrpoly1Meg = 912u
...
* .param CMIM_model = 
*new naming
.param CMIM_1pF_W = 111u
*new naming
.param CMIM_1pF_L = 9u
.param CMIM_ffperum2 = 1
*POD or NIC capacitor
.param CPOD = 1
*model name (experimental)
* .param CPOD_model = 
.param CPOD_1pF_W = 33u
.param CPOD_1pF_L = 6u
.param CPOD_ffperum2 = 5
...
.param IO_ESD_Rsheet = 127
.param IO_ESD50_L = 7.9u
.param IO_ESD50_W = 20u
.param IO_ESD20_L = 6.3u
*should evolve to W<=40u
.param IO_ESD20_W = 40u
.param IO_ESDdiode_L = 2.2u
.param IO_ESDdiode_W = 20.2u

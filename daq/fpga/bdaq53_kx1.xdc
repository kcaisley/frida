...
# Pin mapping from bdaq53_KX1.xdc (RJ45 HITOR block)
# TODO: Assign RJ45 D pins to specific FRIDA signals based on SCC PCB routing
# Available pins (active, directly from bdaq53 KX1 xdc):
#   Pins 1-2: A18 / A19
#   Pins 3-6: F17 / E17
#   Pins 4-5: E15 / E16
#   Pins 7-8: G15 / F15
set_property PACKAGE_PIN A18 [get_ports SPI_SCLK]
set_property PACKAGE_PIN A19 [get_ports SPI_SDI]
set_property PACKAGE_PIN F17 [get_ports SPI_SDO]
set_property PACKAGE_PIN E17 [get_ports SPI_CS_B]
set_property PACKAGE_PIN E15 [get_ports RST_B]
set_property PACKAGE_PIN E16 [get_ports AMPEN_B]

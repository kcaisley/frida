...
#   RJ45 D pins:     TODO - need KX2 mapping for RJ45 D port
#
...
# TODO: Assign DP5 lanes to specific FRIDA signals based on SCC PCB routing
...
# TODO: Need KX2 pin mapping for RJ45 D port from BDAQ53 schematic
# TODO: Assign RJ45 D pins to specific FRIDA signals based on SCC PCB routing
# set_property PACKAGE_PIN XXX [get_ports SPI_SCLK]
# set_property PACKAGE_PIN XXX [get_ports SPI_SDI]
# set_property PACKAGE_PIN XXX [get_ports SPI_SDO]
# set_property PACKAGE_PIN XXX [get_ports SPI_CS_B]
# set_property PACKAGE_PIN XXX [get_ports RST_B]
# set_property PACKAGE_PIN XXX [get_ports AMPEN_B]
